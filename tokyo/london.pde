...
PImage b;
void setup() { b=loadImage("lon1.jpg");
size(580,340);
background(#2A363B);
  rectMode(CENTER);
  frameRate(3);
...
void draw()
{b.resize(120,80);
  image(b,460,100);if(k<=8){stroke(255,0,0);
fill(255,0,0);
...
stroke(255,255,0);
fill(255,255,0);
ellipse(270,40,40,40);
stroke(#2A363B);
fill(#2A363B);
ellipse(260,30,50,50);
}

if(k>18){  stroke(#2A363B);
  fill(#2A363B);
  rect(270,40,50,50);
  fill(255,0,0);
  ellipse(270,40,50,50);
...
k++;//sun and moon
  fill(#FECEA8);
textSize(50);
text("London",330,80);fill(  #9370DB);
stroke(  #9370DB);
