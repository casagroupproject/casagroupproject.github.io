...
int num[]={63,71,72,97,82,85,69,89,96,150,159,184,186,148,102,68,67,63,70,88,80,122,83,86};
...
//y
text("NUM",5*g,(340-(225*y+20)-10)*g);
}
...
stroke(255,255,0);
fill(255,255,0);
ellipse((300)*g,50*g,40*g,40*g);
stroke(bcolor);
fill(bcolor);
ellipse(290*g,40*g,50*g,50*g);}
if(k>=dt&k<=23){ 
  stroke(bcolor);
  fill(bcolor);
  rect(310*g,60*g,55*g,60*g);
  stroke(sun);
  fill(sun);
