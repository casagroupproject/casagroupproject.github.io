...
function preload() {
  ...
  //table = loadTable('http://0.0.0.0:8000/circadian/circadian_paris.csv', 'csv', 'header');
  table = loadTable('circadian/circadian_paris.csv', 'csv', 'header');
...
function draw() {
  ...
  push();
    ...
    textFont(font, 20);
    text('PLACE: Paris', width*.55, height*.85, 360, 200);
