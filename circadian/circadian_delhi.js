...
function preload() {
  ...
  //table = loadTable('http://0.0.0.0:8000/circadian/circadian_delhi.csv', 'csv', 'header');
  table = loadTable('circadian/circadian_delhi.csv', 'csv', 'header');
...
function draw() {
  ...
  push();
    ...
    textFont(font, 20);
    text('PLACE: Delhi', width*.55, height*.85, 360, 200);
